...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2024 at 08:09 AM
...
INSERT INTO `test_slot` (`s_id`, `u-id`, `car_design_id`, `showroom_id`, `full_name`, `email`, `phone`, `date`, `time`) VALUES
...
(26, 1, 35, 2, 'Shibin', 'Shibin@gmail.com', '964457428', '2023-12-15', '23:48:00'),
...
(25, 26, 'BOOKED', '2023-12-29 10:09:14'),
...
INSERT INTO `user` (`u_id`, `email`, `password`, `name`, `phone`) VALUES
(1, 'test@gmail.com', 'asshdjHhshaj', 'test', '1234567890');
...
--
ALTER TABLE `car_design`
  MODIFY `car_design_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `test_slot`
  ADD CONSTRAINT `test_slot_ibfk_1` FOREIGN KEY (`u-id`) REFERENCES `user` (`u_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `test_slot_log`
  ADD CONSTRAINT `test_slot_log_ibfk_1` FOREIGN KEY (`s_id`) REFERENCES `test_slot` (`s_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
